--ESIMERKKI TIETOKANNAN HÄNÄTLOKIN LUOMISESTA JA TÄYSVARMISTUKSEN JA HÄNTÄLOKIN PALAUTUKSESTA
...
--Varmuuskopioi transaktioloki -> LaiterekisteriTaiLog-log tiedostoon
